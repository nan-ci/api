...
test('# method: getPossibleInstructions', [
  ...
  t => t.deepEqual(getPossibleInstructions(actives).sort(), possibles, 'handles all combinations (pre-calculated)'),
  t => t.deepEqual(getPossibleInstructions(actives).sort(), _possibles, 'handles all combinations'),
])
